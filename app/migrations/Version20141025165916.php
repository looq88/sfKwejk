 ...
 */
class Version20141025165916 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, mem_id INT DEFAULT NULL, created_at DATETIME NOT NULL, comment LONGTEXT NOT NULL, ip VARCHAR(255) NOT NULL, user_agent VARCHAR(255) NOT NULL, host VARCHAR(255) NOT NULL, INDEX IDX_9474526CDE12AB56 (created_by), INDEX IDX_9474526C43676E6 (mem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, mem_id INT DEFAULT NULL, create_at DATETIME NOT NULL, rating SMALLINT NOT NULL, INDEX IDX_D8892622DE12AB56 (created_by), INDEX IDX_D889262243676E6 (mem_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mem (id INT AUTO_INCREMENT NOT NULL, created_by INT DEFAULT NULL, created_at DATETIME NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, image_name VARCHAR(255) NOT NULL, is_accepted VARCHAR(255) NOT NULL, INDEX IDX_94C70366DE12AB56 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
